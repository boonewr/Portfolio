...
export const projects = [
    {
        ...
        caseStudySections: [
            ...
            },
            {
                ...
                body: [
                    "The completed codebase was handed over as a project deliverable, so I cannot publish the repository publicly on GitHub.",
                    "Instead, I recorded focused demos that show the core experience: general metadata exploration across connected entities and the full create-entity workflow, which was the most complex interaction path in the system."
                ],
            },
        ],
        ...
        links: [
            {
                label: "Explore Demo",
                href: "https://youtu.be/rLYb0ibaabU",
            },
            {
                label: "Create Demo",
                href: "https://youtu.be/0YrYnJBS7Vg",
            },
        ],
        demoVideos: [
            {
                title: "Explore Demo",
                href: "https://youtu.be/rLYb0ibaabU",
                thumbnail: "https://i.ytimg.com/vi/rLYb0ibaabU/hqdefault.jpg",
                alt: "Metadata Explorer browsing and network graph demo thumbnail",
                description:
                    "General browsing through entities, including full visualizations and the network graph exploration flow.",
            },
            {
                title: "Create Demo",
                href: "https://youtu.be/0YrYnJBS7Vg",
                thumbnail: "https://i.ytimg.com/vi/0YrYnJBS7Vg/hqdefault.jpg",
                alt: "Metadata Explorer create entity workflow demo thumbnail",
                description:
                    "Walkthrough of creating a new entity, the most complex step in the application workflow.",
            },
        ],
        gallery: [
            {
  ...
  setLocalRecentAlerts(categorizeAlerts(enrichedRecent, location.countyName).local);
    ...
    },
    {
        ...
        gallery: [
            ...
            {
                src: "/images/projects/trees-for-the-triangle/spread-the-word.png",
                label: "Future spread the word preview",
                alt: "Trees for the Triangle spread the word page preview",
            },
            {
                src: "/images/projects/trees-for-the-triangle/donate.png",
                label: "Future donate preview",
                alt: "Trees for the Triangle donate page preview",
            },
        ],
