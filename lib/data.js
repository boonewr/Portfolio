...
export const projects = [
  {
    ...
    caseStudySections: [
      ...
      },
      {
        title: "Architecture",
        body: [
          "The application used a decoupled Python backend and React frontend, with PostgreSQL as the source of structured metadata and relationship records.",
          "The backend owned validation, routing, and database access while the frontend consumed stable REST responses for entity detail views and graph-driven exploration.",
        ],
      },
      {
        title: "Execution",
    ...
    caseStudySections: [
      {
        ...
        body: [
          ...
          "The value was improving user engagement and making common nonprofit workflows easier to understand across desktop and mobile contexts.",
        ],
      },
      {
        title: "Architecture",
        body: [
          "The redesign centered on reusable React components, responsive page structure, and accessible content patterns rather than a complex backend.",
          "Interface work was organized so page layouts, repeated content modules, and mobile states could be iterated independently while keeping the experience consistent.",
        ],
      },
      {
        title: "Execution",
        body: [
          ...
          "Iteration focused on usability testing, smaller frontend branches, and responsive adjustments that could be merged without disrupting parallel design work.",
        ],
      },
    ],
    sidebarTitle: "Role & Responsibilities",
